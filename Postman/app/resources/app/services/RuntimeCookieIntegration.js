...
function addCookiesFromJarToCookieManager (cookiePartitionId, cookieJar, cookieManager, transformedUrl, cb) {
  ...
  // using path=null here to fetch all cookies for the domain
  // Refer: https://github.com/salesforce/tough-cookie#storefindcookiesdomain-path-cberrcookies
  cookieJar._jar.store.findCookies(domain, null, (error, cookiesFromJar) => {
